...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.like-button').forEach(button => {
        button.addEventListener('click', function() {
            ...
            button.dataset.likeMode = window.currentFeedMode || "default";
        });
    });
    ...
    function replyOneUp(docId) {
        ...
        if (replyText) {
            ...
            replyField.value = '';
            repliesData.push({ doc_id: docId, reply: replyText, mode: window.currentFeedMode || "default" });
    ...
    function collectLikes() {
        document.querySelectorAll('.like-button').forEach(button => {
            ...
            let mode = button.dataset.likeMode || window.currentFeedMode || "default";
